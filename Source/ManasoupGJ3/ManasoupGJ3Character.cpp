...
AManasoupGJ3Character::AManasoupGJ3Character()
{
...
void AManasoupGJ3Character::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void AManasoupGJ3Character::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
